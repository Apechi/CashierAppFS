<div class="row">
    <x-inputs.group class="col-sm-12">
        <x-inputs.text name="name" label="Nama" placeholder="Nama Tipe" required></x-inputs.text>
    </x-inputs.group>

    <x-inputs.group class="col-sm-12 col-lg-5">
        <x-inputs.text name="icon" label="Icon" placeholder="font-awesome icom" required></x-inputs.text>
    </x-inputs.group>
